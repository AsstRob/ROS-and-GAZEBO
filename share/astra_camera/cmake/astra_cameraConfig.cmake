...
if("FALSE" STREQUAL "TRUE")
  set(astra_camera_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-astra-camera-0.2.2)
  set(astra_camera_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-astra-camera-0.2.2/obj-x86_64-linux-gnu/devel)
  ...
  set(astra_camera_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'astra_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Tim Liu <liuhua@orbbec.com>' to fix it.")
    endif()
