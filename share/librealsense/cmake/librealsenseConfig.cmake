...
if("FALSE" STREQUAL "TRUE")
  set(librealsense_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-librealsense-1.12.1)
  set(librealsense_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-librealsense-1.12.1/obj-x86_64-linux-gnu/devel)
  ...
  set(librealsense_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'librealsense' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Sergey Dorodnicov <sergey.dorodnicov@intel.com>, Mark Horn <mark.d.horn@intel.com>, Reagan Lopez <reagan.lopez@intel.com>' to fix it.")
    endif()
